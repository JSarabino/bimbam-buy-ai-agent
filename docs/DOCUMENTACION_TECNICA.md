# Documentación técnica de BimBam Assistant

Esta guía conserva la documentación detallada de arquitectura, indexación, verificación, monitoreo, evaluación, Docker y despliegue en OCI.
...
![Aplicación pública de BimBam Assistant en OCI](images/app-publica-oci.png)

#### Fuentes y fragmentos recuperados

![Fuentes y fragmentos recuperados por el sistema RAG](images/respuesta-rag-oci.png)

#### Instancia de Oracle Cloud en ejecución

![Instancia OCI en estado Running](images/instancia-oci-running.png)

#### Salud del contenedor y recursos del servidor

![Contenedor Docker healthy y recursos de OCI](images/docker-healthy-oci.png)


#### Monitoreo y registro de ejecución

![Panel de monitoreo de interacciones ejecutadas en OCI](images/monitoreo-produccion-oci.png)

El panel registra fecha UTC, pregunta, categoría, resultado, verificación,
confianza, fuentes, latencia, feedback y errores. Las interacciones se
registran de manera anónima porque la versión demostrativa no incorpora
